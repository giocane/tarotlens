(function () {
    ...
    const DICT = {
        fr: {
            ...
            hero_cta_precommande: "PRÉCOMMANDEZ VOTRE TAROT",
            extension_cta: "Ajouter le pack avec l'extension — {price} €",
            extension_includedWith: "Inclus avec {name}",
        ...
        en: {
            ...
            hero_cta_precommande: "PRE-ORDER YOUR DECK",
            extension_cta: "Add the bundle with extension — €{price}",
            extension_includedWith: "Included with {name}",
